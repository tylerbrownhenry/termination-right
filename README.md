This is a fork of [Termination](https://github.com/Fred-Barclay/Termination), except with the toolbar moved to right side.

![demo](https://github.com/tylerbrownhenry/termination-right/blob/master/resources/demo.png)
